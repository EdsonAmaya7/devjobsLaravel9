    ...
    <div class="max-w-7xl mx-auto">
        ...
        >
            <div class="md:grid md:grid-cols-3 gap-5">
                <div class="mb-5">
                    <label class="block mb-1 text-sm text-gray-700 uppercase font-bold" for="termino">
                        Término de
                        Búsqueda (Empresa ó Titulo)
                    </label>
                    <input type="text" id="termino" placeholder="Buscar por Término: ej. Laravel" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300
                ...
                <div class="mb-5">
                    <label class="block mb-1 text-gray-700 uppercase font-bold"> Salario Mensual</label>
            ...
            <div class="flex justify-end">
                <input type="submit" class="bg-indigo-500 hover:bg-indigo-600 transition-colors text-white text-sm font-bold px-10 rounded
                py-2 cursor-ponter uppercase w-full md:w-auto" value="Buscar">
            </div>
